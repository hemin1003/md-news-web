										...
										if(res.data[i].outsidePosition == 6) {
											if((that.getQueryString("froms") == "ytt") || (parent !== window)) {
												...
												if(res.data[i].type == 89) {
													that.adRecordFn('',"NEWS_OUT_ADS",89,res.data[i].adsId,'',res.data[i].title,res.data[i].url,1);
												}else {
							...
							function selectType(dom,top,report,index) {
								...
								switch(res.data[i].type){
									...
									case 86:
										switch(dom) {
											case ".top_ads":
												that.baiduFn(dom,"//cdn.ipadview.com/jssdk/combo.bundle.js","20035","h5a20180523ban223");
												break;
											case ".title_ad":
												that.baiduFn(dom,"//cdn.ipadview.com/jssdk/combo.bundle.js","20035","yuetth5a2018092603xxl");
												break;
											case ".article_ad":
												that.baiduFn(dom,"//cdn.ipadview.com/jssdk/combo.bundle.js","20035","yuetth5a2018092601xxl");
												break;	
										}
										break;
									case 89:
